      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className="px-3 flex w-full rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-card"
          >
            {selectedValues.length > 0 ? (
              ...
              <div className="flex items-center justify-between w-full mx-0 px-0">
                <span className="text-sm text-muted-foreground font-normal mx-0 px-0">
                  {placeholder}
                </span>
